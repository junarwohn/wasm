...
var ASM_CONSTS = {
  3890: function($0, $1) {setTimeout(function() { _do_emscripten_dispatch_to_thread($0, $1); }, 0);}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=7680;function _emscripten_futex_wake(addr, count) {
